package ru.kaznacheev.wallet.userservice.validation;
...
public class ConfigurableSizeCharArrayValidator implements ConstraintValidator<ConfigurableSize, char[]> {
    ...
    @Override
    public boolean isValid(char[] value, ConstraintValidatorContext constraintValidatorContext) {
